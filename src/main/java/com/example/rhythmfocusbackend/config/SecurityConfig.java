package com.example.rhythmfocusbackend.config;
...
import com.example.rhythmfocusbackend.filter.JWTFilter;
import com.example.rhythmfocusbackend.filter.LoginFilter;
import com.example.rhythmfocusbackend.handler.RefreshTokenLogoutHandler;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        // 기본 Form 기반 인증 필터들 disable (default 로그인 필터 off)
        http
